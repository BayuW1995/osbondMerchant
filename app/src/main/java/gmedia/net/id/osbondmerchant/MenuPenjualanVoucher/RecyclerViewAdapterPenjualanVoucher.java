...
public class RecyclerViewAdapterPenjualanVoucher extends RecyclerView.Adapter<RecyclerViewAdapterPenjualanVoucher.ViewHolder> {
    private Context context;
    private ArrayList<SetGetMasterPaketBaruPenjualanVoucher> rvData;
    private int lastPosition = -1;

    public RecyclerViewAdapterPenjualanVoucher(Context context, ArrayList<SetGetMasterPaketBaruPenjualanVoucher> rvData) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapterPenjualanVoucher.ViewHolder holder, final int position) {
        ...
        holder.group.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.selectedPaketPenjualanVoucher = rvData.get(position);
                notifyDataSetChanged();
            }
        });
